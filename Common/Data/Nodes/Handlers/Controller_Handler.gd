...
func _ready() -> void:
	#TODO: use the world state instead if this is needed
	load('uid://b047ftosxvj7p').level_loaded.connect(on_level_changed)
	#Game.world.level_changed.connect(on_level_changed)
	pass
